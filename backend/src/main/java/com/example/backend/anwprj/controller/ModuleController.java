...
public class ModuleController
{
     ...
     */
    @CrossOrigin
    @DeleteMapping("/module/bysemesterid")
    public void deleteModuleBySemesterID(@RequestParam(name = "sessionid") String sessionid, @RequestParam(name="id") int id)
    {
        User u = UserSessionIDHandler.getUserBySessionID(sessionid);
        if (u != null && u.getPermissions() == UserPermissions.admin.getValue())
        {
            db.deleteModuleBySemesterID(id);
        }
